...
## BOB Hands-On Lab Project

This project is used for the **BOB (Business Optimization and Business Rules) Hands-On Lab** to demonstrate DMN decision modeling capabilities and business rule implementation.

### Lab Objective

In this hands-on lab, you will learn how to:
- Modify DMN decision models to implement new business regulations
- Use FEEL (Friendly Enough Expression Language) for conditional logic
- Test and validate decision model changes
- Work with DMN decision tables and information requirements
...
```json
{
 "namespace": "https://kie.apache.org/dmn/_E93F1115-55C7-4F4D-A81E-0C65833FC8D3",
 ...
 "messages": [
  {
   "severity": "ERROR",
   "message": "Error while evaluating node 'MyDecision' for dependency 'p1': the dependency value '{Interests=[Dancing], Name=Joe}' is not allowed by the declared type (DMNType{ https://kie.apache.org/dmn/_E93F1115-55C7-4F4D-A81E-0C65833FC8D3 : Person })",
